...
int assign_struct(void) {  
	...
	FPID.maximum = 100.0f;           /*输入值的上限*/
	FPID.minimum = 0;                /*输入值的下限*/
	
	FPID.maxdKp = 50.0f;             /*Kp增量的最大限值*/
	FPID.mindKp = 0;                 /*Kp增量的最小限值*/
	FPID.qKp = 2.0f;                 /*Kp增量的影响系数*/
	FPID.maxdKi = 50.0;              /*Ki增量的最大限值*/
	FPID.mindKi = 0;                 /*Ki增量的最小限值*/
	FPID.qKi = 2.0f;                 /*Ki增量的影响系数*/
	FPID.maxdKd = 50.0;              /*Kd增量的最大限值*/
	FPID.mindKd = 0;                 /*Kd增量的最小限值*/
	FPID.qKd = 2.0f;                 /*Kd增量的影响系数*/
...
//	return (-vPID->data_kp * vPID->iError*10						//比例项
