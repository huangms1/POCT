...
{  
	...
	GPIO_Initure.Pin = TEMP_PWM_GPIO_PIN1; 
	GPIO_Initure.Mode = GPIO_MODE_AF_PP;    
	GPIO_Initure.Pull = GPIO_PULLUP;        
	GPIO_Initure.Speed = GPIO_SPEED_HIGH;   
	GPIO_Initure.Alternate = GPIO_AF3_TIM8; 
	HAL_GPIO_Init(TEMP_PWM_GPIO_PORT1,&GPIO_Initure); 

	GPIO_Initure.Pin = TEMP_PWM_GPIO_PIN2; 
	GPIO_Initure.Mode = GPIO_MODE_AF_PP;     
	GPIO_Initure.Pull = GPIO_PULLUP;          
	GPIO_Initure.Speed = GPIO_SPEED_HIGH;    
	GPIO_Initure.Alternate = GPIO_AF3_TIM8;  
	HAL_GPIO_Init(TEMP_PWM_GPIO_PORT2,&GPIO_Initure); 

	GPIO_Initure.Pin = TEMP_PWM_GPIO_PIN3; 
	GPIO_Initure.Mode = GPIO_MODE_AF_PP;     
	GPIO_Initure.Pull = GPIO_PULLUP;           
	GPIO_Initure.Speed = GPIO_SPEED_HIGH;    
	GPIO_Initure.Alternate = GPIO_AF3_TIM9;   
	HAL_GPIO_Init(TEMP_PWM_GPIO_PORT3,&GPIO_Initure); 
...
{
//	HAL_TIM_PWM_MspInit();	
	TIM8_PWM_Init(999,400-1); //第一路和第二路温控。
	
	TIM9_PWM_Init(999,400-1); //第三路温控。	
}
