...
#define SPIx_WIZINT_GPIO_CLK_ENABLE()        	__HAL_RCC_GPIOC_CLK_ENABLE() 
#define SPIx_WIZRESET_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOC_CLK_ENABLE() 
...
#define WIZ_RESET               GPIO_PIN_4									/* 定义W5500的INT管脚           */
...
void timer5_init(void);																/*STM32定时器2初始化*/
void timer5_isr(void);																/*定时器中断执行的函数*/
