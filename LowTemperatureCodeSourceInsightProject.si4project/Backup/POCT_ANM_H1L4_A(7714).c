...
//	Motor_Abs_Run(Globle.POCT_Par.M08_LED_P[num],M08);
	if(num == 0)
		...
		MotorFre_Abs_Run(Globle.POCT_Par.M08_LED_P[num],M08,M08_DIR,4000);
...
//			fre =  Motor_Fre(Globle.POCT_Par.M01_P1);
			...
			MotorFre_Abs_Run(Globle.POCT_Par.M01_P1,M01,M01_DIR,4000);
...
//		fre =  Motor_Fre(Globle.POCT_Par.M02_P2);
		...
		MotorFre_Abs_Run(Globle.POCT_Par.M02_P2,M02,M02_DIR,4000);
