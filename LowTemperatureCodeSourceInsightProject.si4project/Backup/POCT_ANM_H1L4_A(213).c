...
{
	uint32_t offset0 = 0,offset1 = 0,offset2 = 0,step;
...
//		}
//		else
//			Motor_Run(step,M10,M10_DIR,400);
//	}
//	else
//	{
//		Motor_Run(step+offset2,M10,CCW,400);	
//	}
