...
#define IS_BOOTLOADER_PROGRAM        0
	...
	#define  INSTRUMENTS_VERSION   "@S_POCT_ANM_H1L4_A_V1.0.0.VT03.Beta.20230331_E@"
	
#elif defined POCT_ANM_H3L5_A
	#include "POCT_ANM_H3L5_A.h"
	#define  INSTRUMENTS_VERSION   "@S_POCT_ANM_H3L5_A_V1.0.0.VT03.Beta.20230331_E@"
