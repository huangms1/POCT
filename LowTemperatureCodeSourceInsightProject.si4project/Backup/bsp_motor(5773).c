...
void motor_fast_rst(uint8_t motor_num,uint8_t dir,GPIO_TypeDef *gpio_port,uint16_t gpio_pin)
{
	...
	{
		MotorFre_Abs_Run(500,motor_num,dir,2800);
	}
	
	delay_ms(50);
	
	err = Motor_Rst(350,motor_num,dir,gpio_port,gpio_pin,0);
