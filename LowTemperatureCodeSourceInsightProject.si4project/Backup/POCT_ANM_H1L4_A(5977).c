...
{
	u16 temp[2],SendT2T3buf[4] = {0},temp_up_cnt = 0;
	...
	if(channel == 0)
		temp[1] = Globle.TempControl.Temp_Ch1_Set;
	else if(channel == 1)
		temp[1] = Globle.TempControl.Temp_Ch2_Set;
	else if(channel == 2)
		temp[1] = Globle.TempControl.Temp_Ch3_Set;
	else if(channel == 3)
		temp[1] = Globle.TempControl.Temp_Ch4_Set;

	while (temp[1] - 5 < GetTemp(channel))
	{
